      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            <div className="flex items-center gap-2 px-4 py-2 bg-gray-800 border border-gray-600 rounded min-w-0">
              ...
              <Copy className="w-3.5 h-3.5 text-gray-600 shrink-0" aria-hidden="true" />
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <span className="text-sm text-gray-500 font-mono whitespace-nowrap">{formatCurrency(totalGroupInvestment)} total</span>
            </div>
          </div>
        </div>
